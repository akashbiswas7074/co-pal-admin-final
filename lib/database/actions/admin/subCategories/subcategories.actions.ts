...
export const createSubCategory = async (
  ...
  try {
    ...
    console.log("Sub-category created successfully:", newSubCategory._id);
    ...
    return {
      ...
      subCategories: JSON.parse(JSON.stringify(subCategories)),
      newSubCategory: JSON.parse(JSON.stringify(newSubCategory)), // Return the newly created sub-category
    };
  } catch (error: any) {
    console.error("Error creating sub-category:", error);
    return {
      success: false,
      message: `Error creating sub-category: ${error.message || error}`,
      subCategories: [],
      newSubCategory: null,
    };
  }
