        ...
        >
          ...
          <div>
            ...
            <Typography variant="body2" component="div">
              ...
              <br />
              <b>• Order Status:</b> Change status for entire orders or individual products
              <br />
              <b>• Shipment Management:</b> Create, track, edit, and manage shipments directly from each order
              <br />
              <b>• Real-time Updates:</b> See shipment status, waybill numbers, and tracking information inline
            </Typography>
          </div>
        </Box>
        ...
        >
          ...
          <div>
            ...
            <Typography variant="body2">
              <b>• Quick Actions:</b> Create shipments, download labels, track packages, and manage delivery details
              <br />
              <b>• Status Updates:</b> Order and product statuses update automatically when shipments are created or updated
              <br />
              <b>• Address Processing:</b> Use "Process Address" to validate and set delivery addresses before creating shipments
            </Typography>
          </div>
        </Box>
