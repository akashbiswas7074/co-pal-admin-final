...
export default function VendorWarehousePage() {
  ...
  const handleWarehouseCreated = (data: any) => {
    ...
    // Switch to list view to show the created warehouse
    setActiveTab('list');
  };
  ...
  const handleWarehouseUpdated = (data: any) => {
    ...
    setActiveTab('list');
    // You could update the warehouse in the list here
  };
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage your pickup locations for product shipments
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                • Warehouse names are case-sensitive. Use the exact same name when creating orders<br/>
                • You must register at least one warehouse before you can ship products<br/>
                • Return address can be the same as your warehouse address or a different location
              </p>
            </div>
          </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600">My Warehouses</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {warehouseCreated ? '1' : '0'}
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="create" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add a new pickup location for your products. This will be registered with Delhivery for shipping.
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="list" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View and manage your registered pickup locations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <WarehouseList 
